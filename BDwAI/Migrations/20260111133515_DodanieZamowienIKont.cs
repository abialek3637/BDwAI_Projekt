...
{
    /// <inheritdoc />
    public partial class DodanieZamowienIKont : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ElementyZamowienia", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ElementyZamowienia_Produkty_ProduktId",
                        column: x => x.ProduktId,
                        principalTable: "Produkty",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ElementyZamowienia_Zamowienia_ZamowienieId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ElementyZamowienia_ProduktId",
                table: "ElementyZamowienia",
                column: "ProduktId");

            migrationBuilder.CreateIndex(
                name: "IX_ElementyZamowienia_ZamowienieId",
                table: "ElementyZamowienia",
                column: "ZamowienieId");
